...
version_file = path.join(path.dirname(__file__), 'photovoltaic_modeling/version.py')
with open(version_file, 'r') as f:
    exec(f.read())

setup(
    name='photovoltaic_modeling_python',
    ...
    url='https://github.com/tadatoshi/photovoltaic_modeling_python',
    ...
    classifiers=[
        ...
        # TODO: Verify if the code works with Python 2.6 and 2.7.
    ...
    packages=['photovoltaic_modeling', 'tests.photovoltaic_modeling', 'photovoltaic_modeling.parameter', 'tests.photovoltaic_modeling.parameter', 'photovoltaic_modeling.examples'], 
    ...
    entry_points={
        'console_scripts': [
            'photovoltaic_modeling=photovoltaic_modeling.command_line:main',
        ],
    },
)